...
from tplinkrouterc6udraftsms.common.dataclass import Firmware, Status, IPv4Status, IPv4Reservation
from tplinkrouterc6udraftsms.common.dataclass import IPv4DHCPLease, Device, VPNStatus
